...
- [Specification](spec.md) -- authoritative v1 specification with numbered requirements (R1-R47)
- [CLI Reference](cli-index.md) -- all commands, flags, and arguments
- [Embedded Data](embedded-data.md) -- text/binary classification lists and default exclusions
